...
<div style="padding-bottom: 10px;">
    <nav class="mb-1 navbar navbar-expand-lg navbar-light bg-light shadow-sm">    	
    	<a class="navbar-brand" href="{{url('/')}}">
           <img src="{{url('assets/img/safari-pinned-tab.svg')}}" width="30" height="30" alt="logo">
            home
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link" href="mailto:omarmd2311@gmail.com?subject=ContactUs">Contact Us</a></li>
                    <li class="nav-item"><a class="nav-link" href="mailto:omarmd2311@gmail.com?subject=Report">Report</a></li>
